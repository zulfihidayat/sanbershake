...
export default function PetaDirasakan({ navigation, route }) {
  const {
    Tanggal,
    Jam,
    Magnitude,
    ...
    >
      ...
      >
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <View>
            <Text style={{ fontWeight: "700", fontSize: 20, color: "orange" }}>
              Gempa Dirasakan
            </Text>
          </View>
        </View>
      ...
      <View style={{ flexDirection: "column" }}>
        ...
        >
          ...
          <View style={{ flexDirection: "column", paddingLeft: 10 }}>
            ...
            <Text style={{ fontSize: 15 }}>{Dirasakan}</Text>
          </View>
        </View>
        <View
          style={{
